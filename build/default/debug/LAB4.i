            ...
            if (times<1)
              {
                ...
                _delay((unsigned long)((4000)*(8000000UL/4000.0)));
                Lcd_Clear();
                Lcd_Set_Cursor(1,1);
                ...
                Lcd_Set_Cursor(2,1);
                Lcd_Write_String("numero de 0 a 59");
                Lcd_Blink();
                Numpad_en=1;
                Borrado_En=1;
                times++;
...
void __attribute__((picinterrupt(("low_priority"))))LOW_PRIORITY()
  {
  ...
  if(INTCONbits.RBIF==1)
    {
      if(PORTB != 0b11110000)
        ...
        if (E_stop_En==0)
        {
          ...
          if(Numpad_en==1 && Borrado==0 && back_l_En==0 && reset_En==0)
          {
